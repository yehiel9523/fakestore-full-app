...
mongoose.connect(" mongodb+srv://yehiel9523:d.dag.d.p@cluster0.xjoo6.mongodb.net/myFirstDatabase?retryWrites=true&w=majority" || 'mongodb://localhost:27017/store', { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false });
